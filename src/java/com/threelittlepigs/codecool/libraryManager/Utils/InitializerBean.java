...
public class InitializerBean {
    ...
    public InitializerBean(UserService us, FineService fs, BookService bs) {
        ...
        Librarian amigo = new Librarian("amigo", "asdasdasd", "Béla", "Kvács", "bk@gmail.cm", "2007-12-03", "Fixaddress", "0908070605");
        amigo.setPicture("http://res.cloudinary.com/library-codecool/image/upload/v1519907904/familyguy_nrpdjc.png");
        us.saveUser(amigo);
